...
validate_recipe_outputs "terraform-provider-newrelic-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="terraform-provider-newrelic-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi